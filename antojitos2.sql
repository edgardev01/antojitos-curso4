...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 17-12-2024 a las 18:43:40
...
(3, '2024-12-16 22:18:08', 'Confirmado', 1, 'Taco de suadero', 1, 9.00, '', 1),
(4, '2024-12-16 22:34:22', 'Pendiente', 1, 'Huarache suadero', 1, 9.00, '', 3),
(5, '2024-12-16 22:34:28', 'Pendiente', 2, 'Taco de pastor', 1, 9.00, '', 3),
(6, '2024-12-17 00:44:50', 'Pendiente', 3, 'Coca cola', 1, 9.00, 'Bebida', 4),
(7, '2024-12-17 00:45:17', 'Pendiente', 3, 'Taco de carnitas', 1, 9.00, '', 4),
(8, '2024-12-17 00:45:23', 'Pendiente', 2, 'Taco de pastor', 1, 9.00, '', 4),
(9, '2024-12-17 00:55:56', 'Pendiente', 3, 'Coca cola', 2, 9.00, 'Bebida', 4),
(10, '2024-12-17 07:14:58', 'Pendiente', 2, 'Huarache longaniza', 9, 9.00, '', 4),
(11, '2024-12-17 07:33:27', 'Pendiente', 3, 'Taco de carnitas', 1, 9.00, '', 4);
...
CREATE TRIGGER `verificar_horario_pedido` BEFORE INSERT ON `pedidos` FOR EACH ROW BEGIN
    ...
    IF NOT ((hora_actual BETWEEN '06:00:00' AND '23:59:59') OR (hora_actual BETWEEN '00:00:00' AND '04:00:00')) THEN
        SIGNAL SQLSTATE '45000'
