...
if (isset($_SESSION['id_cliente'])) {
    echo "<script>console.log('ID Cliente: " . $_SESSION['id_cliente'] . "');</script>";
} else {
...
function guardarPedido(producto_id, nombre, cantidad, precio, categoria) {
    console.log('Enviando:', { producto_id, nombre, cantidad, precio, categoria });
    ...
    .then(response => response.json()) // Obtenemos JSON del servidor
    .then(data => {
